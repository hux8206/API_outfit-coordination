...
RULES = [
    ...
    ("di_lam","toi_gian","nu","lanh", "ao_len",  "jacket", "quan_tay"),
    ("di_lam","toi_gian","nu","lanh", "ao_len",  "blazer",   "quan_tay"),
    ("di_lam","toi_gian","nu","lanh", "so_mi",   "jacket", "quan_tay"),
    ("di_lam","toi_gian","nu","lanh", "ao_len",  "jacket", "chan_vay"),

    ("di_lam","toi_gian","nam","nong", "so_mi",   "khong_co", "quan_tay"),
    ("di_lam","toi_gian","nam","nong", "polo",    "blazer", "kaki"),
    ("di_lam","toi_gian","nam","nong", "ao_thun", "jacket", "kaki"),
    ("di_lam","toi_gian","nam","nong", "so_mi",   "khong_co", "kaki"),

    ("di_lam","toi_gian","nam","mat",  "so_mi",   "blazer",   "quan_tay"),
    ("di_lam","toi_gian","nam","mat",  "polo",    "khong_co",   "kaki"),
    ("di_lam","toi_gian","nam","mat",  "ao_thun", "jacket", "kaki"),
    ("di_lam","toi_gian","nam","mat",  "ao_len",  "blazer",   "quan_tay"),

    ("di_lam","toi_gian","nam","lanh", "ao_len",  "jacket", "quan_tay"),
    ("di_lam","toi_gian","nam","lanh", "so_mi",   "jacket", "quan_tay"),
    ("di_lam","toi_gian","nam","lanh", "ao_len",  "blazer",   "kaki"),
    ("di_lam","toi_gian","nam","lanh", "polo",    "jacket", "kaki"),
    ...
    ("di_lam","lich_su","nu","lanh", "ao_len",  "jacket", "chan_vay"),
    ("di_lam","lich_su","nu","lanh", "so_mi",   "jacket", "quan_tay"),
    ...
    ("di_lam","lich_su","nam","mat",  "so_mi",   "jacket", "quan_tay"),

    ("di_lam","lich_su","nam","lanh", "ao_len",  "blazer",   "quan_tay"),
    ("di_lam","lich_su","nam","lanh", "so_mi",   "jacket", "quan_tay"),
    ("di_lam","lich_su","nam","lanh", "ao_len",  "jacket", "kaki"),
    ("di_lam","lich_su","nam","lanh", "polo",    "jacket", "quan_tay"),
    ...
    ("di_lam","han_quoc","nu","lanh", "ao_len",  "jacket", "chan_vay"),
    ("di_lam","han_quoc","nu","lanh", "ao_len",  "blazer",   "quan_tay"),
    ("di_lam","han_quoc","nu","lanh", "so_mi",   "jacket", "chan_vay"),
    ...
    ("di_lam","han_quoc","nam","lanh", "ao_len",  "jacket", "kaki"),
    ("di_lam","han_quoc","nam","lanh", "ao_len",  "blazer",   "quan_tay"),
    ("di_lam","han_quoc","nam","lanh", "so_mi",   "jacket", "kaki"),
    ...
    ("di_hoc","toi_gian","nu","mat",  "so_mi",   "jacket",       "quan_tay"),
    ("di_hoc","toi_gian","nu","mat",  "ao_len",  "cardigan",       "quan_ong_suong"),

    ("di_hoc","toi_gian","nu","lanh", "ao_len",  "jacket",       "quan_ni"),
    ("di_hoc","toi_gian","nu","lanh", "ao_len",  "hoodie",         "jeans"),
    ("di_hoc","toi_gian","nu","lanh", "so_mi",   "jacket",       "quan_tay"),
    ...
    ("di_hoc","toi_gian","nam","mat",  "polo",    "jacket",       "kaki"),
    ("di_hoc","toi_gian","nam","mat",  "so_mi",   "cardigan",       "quan_tay"),
    ("di_hoc","toi_gian","nam","mat",  "ao_len",  "jacket",       "jeans"),

    ("di_hoc","toi_gian","nam","lanh", "ao_len",  "jacket",       "quan_ong_suong"),
    ("di_hoc","toi_gian","nam","lanh", "ao_len",  "hoodie",         "jeans"),
    ("di_hoc","toi_gian","nam","lanh", "so_mi",   "jacket",       "kaki"),
    ("di_hoc","toi_gian","nam","lanh", "ao_thun", "jacket",       "jeans"),

    # sporty - nữ
    ("di_hoc","sporty","nu","nong", "ao_thun",  "khong_co",       "quan_ni"),
    ("di_hoc","sporty","nu","nong", "ao_thun",  "ao_chong_nang",  "short"),
    ("di_hoc","sporty","nu","nong", "tank_top", "jacket",       "quan_ni"),
    ("di_hoc","sporty","nu","nong", "polo",     "khong_co",       "jeans"),

    ("di_hoc","sporty","nu","mat",  "ao_thun",  "hoodie",         "quan_ni"),
    ("di_hoc","sporty","nu","mat",  "ao_thun",  "jacket",       "jeans"),
    ("di_hoc","sporty","nu","mat",  "polo",     "hoodie",         "kaki"),
    ("di_hoc","sporty","nu","mat",  "ao_thun",  "cardigan",       "quan_ong_suong"),

    ("di_hoc","sporty","nu","lanh", "ao_thun",  "jacket",       "jeans"),
    ("di_hoc","sporty","nu","lanh", "ao_len",   "hoodie",         "quan_ni"),
    ("di_hoc","sporty","nu","lanh", "ao_thun",  "jacket",       "quan_ong_suong"),
    ("di_hoc","sporty","nu","lanh", "polo",     "jacket",       "kaki"),

    # sporty - nam
    ("di_hoc","sporty","nam","nong", "ao_thun",  "ao_chong_nang",  "kaki"),
    ("di_hoc","sporty","nam","nong", "ao_thun",  "khong_co",       "quan_ni"),
    ("di_hoc","sporty","nam","nong", "tank_top", "jacket",       "short"),
    ("di_hoc","sporty","nam","nong", "polo",     "khong_co",       "kaki"),

    ("di_hoc","sporty","nam","mat",  "ao_thun",  "hoodie",         "kaki"),
    ("di_hoc","sporty","nam","mat",  "ao_thun",  "jacket",       "quan_ong_suong"),
    ("di_hoc","sporty","nam","mat",  "polo",     "hoodie",         "jeans"),
    ("di_hoc","sporty","nam","mat",  "ao_len",   "jacket",       "quan_ni"),

    ("di_hoc","sporty","nam","lanh", "ao_thun",  "jacket",       "quan_ong_suong"),
    ("di_hoc","sporty","nam","lanh", "ao_len",   "hoodie",         "jeans"),
    ("di_hoc","sporty","nam","lanh", "polo",     "jacket",       "kaki"),
    ("di_hoc","sporty","nam","lanh", "ao_thun",  "jacket",       "quan_ni"),

    # streetwear - nữ
    ("di_hoc","streetwear","nu","nong", "crop_top", "khong_co",      "jeans"),
    ("di_hoc","streetwear","nu","nong", "crop_top", "jacket",      "jeans"),
    ...
    ("di_hoc","streetwear","nu","mat",  "crop_top", "jacket",      "jeans"),
    ("di_hoc","streetwear","nu","mat",  "ao_thun",  "jacket",      "quan_ong_suong"),
    ("di_hoc","streetwear","nu","mat",  "ao_len",   "hoodie",        "jeans"),

    ("di_hoc","streetwear","nu","lanh", "ao_thun",  "jacket",      "jeans"),
    ("di_hoc","streetwear","nu","lanh", "ao_len",   "jacket",      "quan_ong_suong"),
    ("di_hoc","streetwear","nu","lanh", "crop_top", "jacket",      "jeans"),
    ...
    ("di_hoc","streetwear","nam","mat",  "ao_thun",  "jacket",      "quan_ong_suong"),
    ("di_hoc","streetwear","nam","mat",  "ao_len",   "hoodie",        "jeans"),
    ("di_hoc","streetwear","nam","mat",  "polo",     "jacket",      "kaki"),

    ("di_hoc","streetwear","nam","lanh", "ao_thun",  "jacket",      "jeans"),
    ("di_hoc","streetwear","nam","lanh", "ao_len",   "jacket",      "jeans"),
    ("di_hoc","streetwear","nam","lanh", "ao_thun",  "hoodie",        "quan_ni"),
    ("di_hoc","streetwear","nam","lanh", "ao_len",   "jacket",      "quan_ong_suong"),
    ...
    ("di_hoc","han_quoc","nu","mat",  "ao_len",  "jacket",  "quan_tay"),
    ...
    ("di_hoc","han_quoc","nu","lanh", "ao_len",  "jacket",  "quan_tay"),
    ("di_hoc","han_quoc","nu","lanh", "ao_len",  "cardigan",  "chan_vay"),
    ("di_hoc","han_quoc","nu","lanh", "so_mi",   "jacket",  "quan_tay"),
    ...
    ("di_hoc","han_quoc","nam","mat",  "ao_len",  "jacket",  "jeans"),
    ("di_hoc","han_quoc","nam","mat",  "so_mi",   "cardigan",  "quan_tay"),
    ("di_hoc","han_quoc","nam","mat",  "ao_thun", "blazer",    "kaki"),
    ("di_hoc","han_quoc","nam","mat",  "polo",    "jacket",  "kaki"),

    ("di_hoc","han_quoc","nam","lanh", "ao_len",  "jacket",  "jeans"),
    ("di_hoc","han_quoc","nam","lanh", "ao_len",  "cardigan",  "kaki"),
    ("di_hoc","han_quoc","nam","lanh", "so_mi",   "jacket",  "quan_tay"),
    ...
    ("di_hoc","vintage","nu","mat",  "polo",    "jacket", "chan_vay"),

    ("di_hoc","vintage","nu","lanh", "ao_len",  "jacket", "chan_vay"),
    ("di_hoc","vintage","nu","lanh", "ao_len",  "cardigan", "quan_tay"),
    ("di_hoc","vintage","nu","lanh", "so_mi",   "jacket", "kaki"),
    ...
    ("di_hoc","vintage","nam","mat",  "ao_thun", "jacket", "kaki"),
    ("di_hoc","vintage","nam","mat",  "polo",    "blazer",   "kaki"),

    ("di_hoc","vintage","nam","lanh", "ao_len",  "jacket", "kaki"),
    ("di_hoc","vintage","nam","lanh", "ao_len",  "cardigan", "quan_tay"),
    ("di_hoc","vintage","nam","lanh", "so_mi",   "jacket", "kaki"),
    ...
    ("di_choi","toi_gian","nu","mat",  "ao_thun", "jacket",      "short"),
    ("di_choi","toi_gian","nu","mat",  "polo",    "cardigan",      "jeans"),
    ("di_choi","toi_gian","nu","mat",  "ao_len",  "jacket",      "quan_ong_suong"),
    ("di_choi","toi_gian","nu","mat",  "so_mi",   "cardigan",      "kaki"),

    ("di_choi","toi_gian","nu","lanh", "ao_len",  "jacket",      "jeans"),
    ("di_choi","toi_gian","nu","lanh", "ao_len",  "hoodie",        "quan_ong_suong"),
    ("di_choi","toi_gian","nu","lanh", "so_mi",   "jacket",      "kaki"),
    ("di_choi","toi_gian","nu","lanh", "polo",    "jacket",      "jeans"),
    ...
    ("di_choi","toi_gian","nam","mat",  "ao_thun", "jacket",      "jeans"),
    ("di_choi","toi_gian","nam","mat",  "polo",    "cardigan",      "kaki"),
    ("di_choi","toi_gian","nam","mat",  "ao_len",  "hoodie",        "jeans"),
    ("di_choi","toi_gian","nam","mat",  "so_mi",   "jacket",      "quan_tay"),

    ("di_choi","toi_gian","nam","lanh", "ao_len",  "jacket",      "jeans"),
    ("di_choi","toi_gian","nam","lanh", "ao_len",  "hoodie",        "quan_ong_suong"),
    ("di_choi","toi_gian","nam","lanh", "so_mi",   "jacket",      "kaki"),
    ("di_choi","toi_gian","nam","lanh", "polo",    "jacket",      "jeans"),
    ...
    ("di_choi","sporty","nu","mat",  "tank_top", "jacket",      "quan_ni"),
    ("di_choi","sporty","nu","mat",  "ao_thun",  "hoodie",        "jeans"),
    ("di_choi","sporty","nu","mat",  "polo",     "jacket",      "kaki"),
    ("di_choi","sporty","nu","mat",  "ao_len",   "cardigan",      "quan_ong_suong"),

    ("di_choi","sporty","nu","lanh", "ao_thun",  "jacket",      "quan_ong_suong"),
    ("di_choi","sporty","nu","lanh", "ao_len",   "hoodie",        "jeans"),
    ("di_choi","sporty","nu","lanh", "tank_top", "jacket",      "quan_ni"),
    ("di_choi","sporty","nu","lanh", "polo",     "jacket",      "kaki"),
    ...
    ("di_choi","sporty","nam","mat",  "ao_thun",  "jacket",      "quan_ong_suong"),
    ("di_choi","sporty","nam","mat",  "ao_thun",  "hoodie",        "jeans"),
    ("di_choi","sporty","nam","mat",  "polo",     "jacket",      "kaki"),
    ("di_choi","sporty","nam","mat",  "ao_len",   "hoodie",        "quan_ni"),

    ("di_choi","sporty","nam","lanh", "ao_thun",  "jacket",      "quan_ong_suong"),
    ("di_choi","sporty","nam","lanh", "ao_len",   "hoodie",        "jeans"),
    ("di_choi","sporty","nam","lanh", "polo",     "jacket",      "kaki"),
    ("di_choi","sporty","nam","lanh", "ao_len",   "jacket",      "quan_ni"),


    # streetwear - nữ
    ("di_choi","streetwear","nu","nong", "ao_thun",  "khong_co",      "short"),
    ("di_choi","streetwear","nu","nong", "crop_top", "khong_co",      "jeans"),
    ("di_choi","streetwear","nu","nong", "tank_top", "jacket",      "short"),
    ("di_choi","streetwear","nu","nong", "ao_thun",  "ao_chong_nang", "quan_ong_suong"),

    ("di_choi","streetwear","nu","mat",  "crop_top", "jacket",      "jeans"),
    ("di_choi","streetwear","nu","mat",  "ao_thun",  "hoodie",        "jeans"),
    ("di_choi","streetwear","nu","mat",  "ao_len",   "jacket",      "quan_ong_suong"),
    ("di_choi","streetwear","nu","mat",  "ao_thun",  "cardigan",      "short"),

    ("di_choi","streetwear","nu","lanh", "crop_top", "jacket",      "jeans"),
    ("di_choi","streetwear","nu","lanh", "ao_len",   "hoodie",        "quan_ong_suong"),
    ("di_choi","streetwear","nu","lanh", "ao_thun",  "jacket",      "short"),
    ("di_choi","streetwear","nu","lanh", "tank_top", "jacket",      "jeans"),
    ...
    ("di_choi","streetwear","nam","mat",  "ao_thun",  "jacket",      "jeans"),
    ("di_choi","streetwear","nam","mat",  "ao_len",   "hoodie",        "jeans"),
    ("di_choi","streetwear","nam","mat",  "tank_top", "jacket",      "quan_ong_suong"),
    ("di_choi","streetwear","nam","mat",  "polo",     "hoodie",        "kaki"),

    ("di_choi","streetwear","nam","lanh", "ao_len",   "jacket",      "jeans"),
    ("di_choi","streetwear","nam","lanh", "ao_thun",  "hoodie",        "quan_ni"),
    ("di_choi","streetwear","nam","lanh", "tank_top", "jacket",      "jeans"),
    ...
    ("di_choi","han_quoc","nu","mat",  "ao_len",  "jacket", "chan_vay"),
    ("di_choi","han_quoc","nu","mat",  "so_mi",   "cardigan", "quan_tay"),
    ("di_choi","han_quoc","nu","mat",  "ao_thun", "blazer",   "chan_vay"),
    ("di_choi","han_quoc","nu","mat",  "polo",    "jacket", "kaki"),

    ("di_choi","han_quoc","nu","lanh", "ao_len",  "jacket", "chan_vay"),
    ("di_choi","han_quoc","nu","lanh", "ao_len",  "cardigan", "quan_tay"),
    ("di_choi","han_quoc","nu","lanh", "so_mi",   "jacket", "chan_vay"),
    ...
    ("di_choi","han_quoc","nam","mat",  "ao_len",  "jacket", "kaki"),
    ("di_choi","han_quoc","nam","mat",  "so_mi",   "cardigan", "quan_tay"),
    ("di_choi","han_quoc","nam","mat",  "ao_thun", "hoodie",   "jeans"),
    ("di_choi","han_quoc","nam","mat",  "polo",    "jacket", "kaki"),

    ("di_choi","han_quoc","nam","lanh", "ao_len",  "jacket", "kaki"),
    ("di_choi","han_quoc","nam","lanh", "ao_len",  "hoodie",   "jeans"),
    ("di_choi","han_quoc","nam","lanh", "so_mi",   "jacket", "quan_tay"),
    ...
    ("di_choi","vintage","nu","mat",  "polo",    "jacket", "chan_vay"),

    ("di_choi","vintage","nu","lanh", "ao_len",  "jacket", "chan_vay"),
    ("di_choi","vintage","nu","lanh", "ao_len",  "cardigan", "quan_tay"),
    ("di_choi","vintage","nu","lanh", "so_mi",   "jacket", "kaki"),
    ...
    ("di_choi","vintage","nam","mat",  "ao_thun", "jacket", "kaki"),
    ("di_choi","vintage","nam","mat",  "polo",    "blazer",   "kaki"),

    ("di_choi","vintage","nam","lanh", "ao_len",  "jacket", "kaki"),
    ("di_choi","vintage","nam","lanh", "ao_len",  "cardigan", "quan_tay"),
    ("di_choi","vintage","nam","lanh", "so_mi",   "jacket", "kaki"),
